          ...
          <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
              ...
              <div class="my-lg-0 my-1">
                <a href="#" class="btn btn-sm btn-success font-weight-bolder text-uppercase">Ajouter</a>
              </div>
            </div>
            <!--end: Title-->
          </div>
          ...
          <div class="flex-grow-1">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
              <div class="mr-3">
                <!--begin::Name-->
                <a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">
                  ASECNA - Aeronautical Information <i class="flaticon2-correct text-success icon-md ml-2"></i>
                </a>
                <!--end::Name-->
              ...
              <div class="my-lg-0 my-1">
                <a href="#" class="btn btn-sm btn-light-warning font-weight-bolder text-uppercase mr-3">Modifier</a>
                <a href="#" class="btn btn-sm btn-danger font-weight-bolder text-uppercase">Supprimer</a>
              </div>
            </div>
            <!--end: Title-->
            ...
            <div class="d-flex align-items-center flex-wrap justify-content-between">
              <div class="flex-grow-1 font-weight-bold text-dark-50 py-5 py-lg-2 mr-5">
                Briefing includes BIRDTAM SNOWTAM ASHTAM NOTAM EXCLUDING NOTAM <br>
                THAT ARE VALID FOR MORE THAN 90 DAYS.
              </div>
              ...
              <div class="d-flex flex-wrap align-items-center py-2">
                <div class="d-flex align-items-center mr-10">
                  <div class="mr-6">
                    ...
                    <span class="btn btn-sm btn-text btn-light-primary text-uppercase font-weight-bold">20 July, 2021</span>
                  </div>
                  <div class="">
                    <div class="font-weight-bold mb-2">Due Date</div>
                    <span class="btn btn-sm btn-text btn-light-danger text-uppercase font-weight-bold">22 July, 2021</span>
                  </div>
                </div>
