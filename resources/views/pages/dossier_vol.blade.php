...
<div class="row">
  ...
  <div class="col-lg-6 col-xxl-4">
    <!--begin::Card-->
    <div class="card card-custom gutter-b card-stretch" style="height: 700px">
      <!--begin::Body-->
      <div class="card-body">
        <!--begin::Section-->
  ...
  <div class="col-lg-6 col-xxl-6">
    <div class="card card-custom overflow-hidden" style="height: 700px">
  ...
  <div class="col-lg-6 col-xxl-2">
      <div class="row justify-content-center bgi-size-cover bgi-no-repeat py-8 px-8 py-md-27 px-md-0 card card-custom" style="background-image: url({{ asset('media/bg/1.jpeg') }}); height: 700px"></div>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col-lg-6 col-xxl-4">
      <div class="row justify-content-center bgi-size-cover bgi-no-repeat py-8 px-8 py-md-27 px-md-0 sm_img card card-custom" style="background-image: url({{ asset('media/bg/3.jpeg') }}); height: 280px"></div>
