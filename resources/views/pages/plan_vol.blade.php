...
<div class="card card-custom">
  ...
  <div class="card-body">
    ...
    <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
      <thead>
        <tr>
          <th title="Field #1" style="width: 30px">#</th>
          ...
          <th title="Field #7">Aircraft ID</th>
          <th title="Field #8">Departure</th>
          <th title="Field #9">Cruising</th>
          <th title="Field #10">Destination</th>
          <th title="Field #11">Other informations</th>
          <th title="Field #12">Pilot</th>
          <th title="Field #13">Filled / Accepted by</th>
      ...
      <tbody>
        ...
        <tr>
          <td>06-36</td>
          <td>
            <span class="label label-primary label-inline font-weight-lighter mr-2  text-white">Normal</span>
          </td>
          <td>2569 Farm Meadow Drive, Clarksville</td>
          <td>08:00</td>
          <td>1099 New York Avenue, Grand prairie</td>
        ...
        <tr>
          <td>06-36</td>
          <td>
            <span class="label label-danger label-inline font-weight-lighter mr-2 text-white">Urgent</span>
          </td>
          <td>2569 Farm Meadow Drive, Clarksville</td>
          <td>08:00</td>
          <td>1099 New York Avenue, Grand prairie</td>
